...
function wordpress_starter_theme_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'wordpress-starter-theme' ),
	) );
...
endif; // wordpress_starter_theme_setup
...
function wordpress_starter_theme_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'wordpress-starter-theme' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function wordpress_starter_theme_scripts() {
	...
	wp_enqueue_script( 'wordpress-starter-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'wordpress-starter-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
